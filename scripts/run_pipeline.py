...
def main():
    ...
    p.add_argument("--peer-ev-ebitda-median", type=float, default=14.0)
    p.add_argument("--peer-ev-ebitda-p75", type=float, default=20.0)
    p.add_argument("--peer-pe-median", type=float, default=25.0)
    ...
    peer_multiples = {
        ...
        "p75_ev_ebitda": args.peer_ev_ebitda_p75,
        "median_pe": args.peer_pe_median,
    }
